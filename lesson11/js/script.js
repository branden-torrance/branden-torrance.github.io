...
if (page.textContent == "Preston" || page.textContent == "Soda Springs" || page.textContent == "Fish Haven") {
    let cityid
    ...
    fetch(weatherURL)
        ...
        .then((weatherStats) => {
            ...
            // Current Temperature
            document.querySelector('#temperature').textContent = weatherStats.main.temp.toFixed(0);
